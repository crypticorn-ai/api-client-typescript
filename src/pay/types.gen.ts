...
/**
 * Model defining a transaction receipt.
 */
 ...
 */
export type UnstakeTokensRequest = {
  /**
   * User's wallet address
   */
  address: string;
  /**
   * Pool ID to unstake from
   */
  pool_id: 1 | 2 | 3;
  /**
...
export type UnstakeTokensData = {
  body: UnstakeTokensRequest;
};

export type UnstakeTokensResponse = TxReceipt;

export type UnstakeTokensError = ErrorResponse;
