...
export const ActionsCountSchema = {
  properties: {
    timestamp: {
      type: "integer",
      title: "Timestamp",
    ...
    count: {
      type: "integer",
      title: "Count",
      description: "The number of actions for the day",
    },
  },
  type: "object",
  required: ["timestamp", "count"],
  title: "ActionsCount",
  description: "The number of actions for a user by day",
} as const;
...
export const BotCreateSchema = {
  ...
  type: "object",
  required: ["name", "allocation", "strategy_id", "api_key_id"],
  title: "BotCreate",
...
export const ExchangeKeySchema = {
  ...
  type: "object",
  required: ["user_id", "created_at", "updated_at", "id", "label", "exchange"],
  title: "ExchangeKey",
  description:
...
export const TPSLSchema = {
  ...
  type: "object",
  required: ["price_delta", "allocation"],
  title: "TPSL",
